...
// the refetching behavior of modules.
let amount = 0
...
describe('refetchOnFocus tests', () => {
  ...
  test('useQuery hook prefers refetchOnFocus: true when multiple modules have different configurations', async () => {
    let data, isLoading, isFetching
...
describe('refetchOnReconnect tests', () => {
  ...
  test('useQuery hook prefers refetchOnReconnect: true when multiple modules have different configurations', async () => {
    let data, isLoading, isFetching
