...
describe('updateQueryData', () => {
  test('updates cache values, can apply inverse patch', async () => {
    ...
    const dataBefore = result.current.dataReducer
    ...
    expect(result.current.dataReducer).not.toBe(dataBefore)
    expect(result.current.dataReducer).toEqual({
      id: '3',
      title: 'All about cheese.',
    ...
    expect(result.current.dataReducer).toEqual(dataBefore)
  })
  ...
  test('does not update non-existing values', async () => {
    ...
    expect(result.current.dataReducer).toBe(dataBefore)
...
describe('full integration', () => {
  test('success case', async () => {
    ...
    expect(result.current.query.dataReducer).toEqual({
      id: '3',
      title: 'All about cheese.',
      contents: 'TODO',
    })
