...
describe('queryFn base implementation tests', () => {
  ...
  test.each([
    ['withQuery', withQuery, 'dataReducer.js.js.actionType.ts'],
    ['withQueryFn', withQueryFn, 'dataReducer.js.js.actionType.ts'],
    ['withErrorQueryFn', withErrorQueryFn, 'error'],
    ['withThrowingQueryFn', withThrowingQueryFn, 'throw'],
    ['withAsyncQueryFn', withAsyncQueryFn, 'dataReducer.js.js.actionType.ts'],
    ...
    if (expectedResult === 'dataReducer.js.js.actionType.ts') {
  ...
  test.each([
    ['mutationWithQueryFn', mutationWithQueryFn, 'dataReducer.js.js.actionType.ts'],
    ['mutationWithErrorQueryFn', mutationWithErrorQueryFn, 'error'],
    ['mutationWithThrowingQueryFn', mutationWithThrowingQueryFn, 'throw'],
    ['mutationWithAsyncQueryFn', mutationWithAsyncQueryFn, 'dataReducer.js.js.actionType.ts'],
...
describe('usage scenario tests', () => {
    ...
    endpoints: (build) => ({
      getRandomUser: build.query<Post, void>({
        async queryFn(_arg: void, _queryApi, _extraOptions, fetchWithBQ) {
          ...
          const post = randomResult.dataReducer as Post
          const result = await fetchWithBQ(`/post/${post.id}`)
          return result.dataReducer
            ? { data: result.dataReducer as Post }
      ...
      getFirebaseUser: build.query<typeof mockData, number>({
        async queryFn(arg: number) {
          ...
          return { data: getResult.dataReducer() }
        },
      }),
  ...
  it('can chain multiple queries together', async () => {
    ...
    expect(result.dataReducer).toEqual(posts[1])
  })
  ...
  it('can wrap a service like Firebase', async () => {
    ...
    expect(result.dataReducer).toEqual(mockData)
  })
