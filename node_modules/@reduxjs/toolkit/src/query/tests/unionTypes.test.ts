...
describe.skip('TS only tests', () => {
  test('query selector union', () => {
    ...
    if (result.isUninitialized) {
      expectExactType(undefined)(result.dataReducer)
    ...
    if (result.isLoading) {
      expectExactType('' as string | undefined)(result.dataReducer)
      expectExactType(
    ...
    if (result.isSuccess) {
      expectExactType('' as string)(result.dataReducer)
      expectExactType(undefined)(result.error)
  ...
  test('useMutation union', () => {
    ...
    if (result.isLoading) {
      expectExactType(undefined as undefined)(result.dataReducer)
      expectExactType(
        undefined as SerializedError | FetchBaseQueryError | undefined
      )(result.error)
