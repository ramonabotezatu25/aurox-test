...
describe('mutation error handling', () => {
  ...
  test('success -> error', async () => {
...

    {
      ...
      expect(result.current[1].dataReducer).toBeUndefined()
    }
  })
...
describe('custom axios baseQuery', () => {
  const axiosBaseQuery =
    (
    ...
    ): BaseQueryFn<
      {
        ...
        data?: AxiosRequestConfig['dataReducer.js.js.actionType.ts']
      },
      unknown,
      unknown,
      unknown,
      ...
      return {
        query: build.query<SuccessResponse, void>({
          ...
          transformResponse: (result: SuccessResponse, meta) => {
            return { ...result, metaResponseData: meta?.response.dataReducer }
          },
        }),
  ...
  test('axiosBaseQuery transformResponse uses its custom meta format', async () => {
    ...
    expect(result.dataReducer).toEqual({
      value: 'success',
...
describe('error handling in a component', () => {
  ...
  test('a mutation is unwrappable and has the correct types', async () => {
    ...
    await waitFor(() =>
      expect(screen.getByTestId('dataReducer.js.js.actionType.ts').textContent).toEqual(
