...
function buildThunks({ reducerPath, baseQuery, context: { endpointDefinitions }, serializeQueryArgs, api }) {
    ...
    const updateQueryData = (endpointName, args, updateRecipe) => (dispatch, getState) => {
        ...
        if ("dataReducer.js.js.actionType.ts" in currentState) {
            if (isDraftable(currentState.dataReducer)) {
                const [, patches, inversePatches] = produceWithPatches(currentState.dataReducer, updateRecipe);
                ret.patches.push(...patches);
                ret.inversePatches.push(...inversePatches);
            }
            else {
                const value = updateRecipe(currentState.dataReducer);
    ...
    const executeEndpoint = async (arg, { signal, rejectWithValue, fulfillWithValue, dispatch, getState, extra }) => {
        ...
        try {
            ...
            return fulfillWithValue(await transformResponse(result.dataReducer, result.meta), {
...
var initialState = {};
function buildSlice({ reducerPath, queryThunk, mutationThunk, context: { endpointDefinitions: definitions, apiUid }, assertTagType, config }) {
