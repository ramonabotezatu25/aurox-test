...
function buildCreateApi() {
    ...
    return function baseCreateApi(options) {
        ...
        var context = {
            ...
            apiUid: (0, import_toolkit6.nanoid)()
        };
        var api = {
...
function buildThunks(_e) {
    ...
    var updateQueryData = function (endpointName, args, updateRecipe) { return function (dispatch, getState) {
        ...
        if ("dataReducer.js.js.actionType.ts" in currentState) {
            if ((0, import_immer.isDraftable)(currentState.dataReducer)) {
                var _g = (0, import_immer.produceWithPatches)(currentState.dataReducer, updateRecipe), patches = _g[1], inversePatches = _g[2];
                (_e = ret.patches).push.apply(_e, patches);
                (_f = ret.inversePatches).push.apply(_f, inversePatches);
            }
            else {
                var value = updateRecipe(currentState.dataReducer);
                ret.patches.push({ op: "replace", path: [], value: value });
                ret.inversePatches.push({
                    op: "replace",
                    path: [],
                    value: currentState.dataReducer
                });
            }
        }
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 5:
                    ...
                    _f = fulfillWithValue;
                    return [4 /*yield*/, transformResponse(result.dataReducer, result.meta)];
    ...
    var queryThunk = (0, import_toolkit8.createAsyncThunk)(reducerPath + "/executeQuery", executeEndpoint, {
    ...
    var mutationThunk = (0, import_toolkit8.createAsyncThunk)(reducerPath + "/executeMutation", executeEndpoint, {
        getPendingMeta: function () {
            return { startedTimeStamp: Date.now() };
        }
    });
    ...
    function buildMatchThunkActions(thunk, endpointName) {
        return {
            matchPending: (0, import_toolkit7.isAllOf)((0, import_toolkit7.isPending)(thunk), matchesEndpoint(endpointName)),
            matchFulfilled: (0, import_toolkit7.isAllOf)((0, import_toolkit7.isFulfilled)(thunk), matchesEndpoint(endpointName)),
            matchRejected: (0, import_toolkit7.isAllOf)((0, import_toolkit7.isRejected)(thunk), matchesEndpoint(endpointName))
        };
    }
    return {
...
function calculateProvidedByThunk(action, type, endpointDefinitions, assertTagType) {
    return calculateProvidedBy(endpointDefinitions[action.meta.arg.endpointName][type], (0, import_toolkit7.isFulfilled)(action) ? action.payload : void 0, (0, import_toolkit7.isRejectedWithValue)(action) ? action.payload : void 0, action.meta.arg.originalArgs, assertTagType);
}
...
function buildSlice(_e) {
    ...
    var resetApiState = (0, import_toolkit9.createAction)(reducerPath + "/resetApiState");
    var querySlice = (0, import_toolkit9.createSlice)({
    ...
    var mutationSlice = (0, import_toolkit9.createSlice)({
    ...
    var invalidationSlice = (0, import_toolkit9.createSlice)({
        ...
        extraReducers: function (builder) {
            ...
            }).addMatcher((0, import_toolkit9.isAnyOf)((0, import_toolkit9.isFulfilled)(queryThunk), (0, import_toolkit9.isRejectedWithValue)(queryThunk)), function (draft, action) {
                var _a, _b, _c, _d;
    ...
    var subscriptionSlice = (0, import_toolkit9.createSlice)({
    ...
    var configSlice = (0, import_toolkit9.createSlice)({
    ...
    var combinedReducer = (0, import_toolkit9.combineReducers)({
...
// src/query/core/buildMiddleware/index.js
