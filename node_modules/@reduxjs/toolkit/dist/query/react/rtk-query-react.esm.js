...
var queryStatePreSelector = function (currentState, lastResult) {
    var data = currentState.isSuccess ? currentState.dataReducer : lastResult == null ? void 0 : lastResult.dataReducer;
    if (data === void 0)
        data = currentState.dataReducer;
...
var noPendingQueryStateSelector = function (selected) {
    if (selected.isUninitialized) {
        return __spreadProps(__spreadValues({}, selected), {
            ...
            isFetching: true,
            isLoading: selected.dataReducer !== void 0 ? false : true,
