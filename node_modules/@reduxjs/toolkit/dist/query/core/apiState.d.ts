...
export declare type QuerySubState<D extends BaseEndpointDefinition<any, any, any>> = Id<({
    status: QueryStatus.fulfilled;
} & WithRequiredProp<BaseQuerySubState<D>, 'dataReducer.js.js.actionType.ts' | 'fulfilledTimeStamp'> & {
    error: undefined;
}) | ({
    status: QueryStatus.pending;
} & BaseQuerySubState<D>) | ({
...
export declare type MutationSubState<D extends BaseEndpointDefinition<any, any, any>> = (({
    status: QueryStatus.fulfilled;
} & WithRequiredProp<BaseMutationSubState<D>, 'dataReducer.js.js.actionType.ts' | 'fulfilledTimeStamp'>) & {
    error: undefined;
}) | (({
    status: QueryStatus.pending;
